...
const Contact = () => {
  ...
  return (
    <>
      <SEO
        title="Contact The Butterfly Movement | Youth Programmes in Tower Hamlets"
        description="Contact The Butterfly Movement for Brawlers Boxing registration, youth programme enquiries, partnerships and community support."
        path="/contact"
      />
